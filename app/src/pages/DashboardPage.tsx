...
const DashboardPage: React.FC<DashboardProps> = ({ onNavigate, onTagClick, notes, onUpload, isUploading, onSelectNote }) => {
  ...
  <div className={styles.page}>
    ...
    <div className={styles.header}>
      <div>
        <h1 className={`${styles.greeting} text-display`}>{t('dashboard.greeting')} 👋</h1>
        <p className={styles.sub}>{t('dashboard.reviewHint')}</p>
      </div>
